...
class Main {
  public static void main(String[] args) {
    ...
    String input_noy = start_scan.next(); //Reads in the number of years that the principle amount accrues.
    ...
    double acrrued_trailing = p*Math.pow(((1.00+(r/cpy))), (cpy*y)); //Accrued amount = Principle*(1+rate/compound)^(rate*years).
    double a = Math.round(acrrued_trailing*100.00)/100.00; //Basic math to get 2 decimal places.

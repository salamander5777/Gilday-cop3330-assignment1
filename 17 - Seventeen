...
class Main {
  public static void main(String[] args) {
    ...
    do{
      ...
      input_gender = start_scan.next(); //Reads in whether or not the individual is female or male.
    ...
    if (input_gender.matches("1")){ //Alcohol distibution ratio for men is: 0.73.
    ...
    System.out.print((BAC >= 0.08) ? "Your BAC is " + BAC + "\nIt is not legal for you to drive.": "Your BAC is " + BAC + "\nIt is legal for you to drive.");  //Prints out your current estimated value of BAC and whether or not it is legal for you to drive based on this.
